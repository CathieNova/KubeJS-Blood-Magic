...
public interface SoulForgeRecipeJS
{
	...
	RecipeKey<InputItem> input1 = ItemComponents.INPUT.key("input1").optional(InputItem.EMPTY);
	RecipeKey<InputItem> input2 = ItemComponents.INPUT.key("input2").optional(InputItem.EMPTY);
	RecipeKey<InputItem> input3 = ItemComponents.INPUT.key("input3").optional(InputItem.EMPTY);
